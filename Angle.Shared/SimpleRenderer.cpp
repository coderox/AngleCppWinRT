...
#else
        throw Platform::Exception::CreateException(E_FAIL, ref new Platform::String(errorMessage.c_str()));
#endif
	}
...
#else
		throw Platform::Exception::CreateException(E_FAIL, L"Program creation failed");
#endif
	}
